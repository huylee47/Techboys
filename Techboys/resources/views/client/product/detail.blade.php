                            ...
                            <div class="techmarket-advanced-reviews" id="reviews">
                                <div class="advanced-review row">
                                    <div class="advanced-review-rating">
                                        <h2 class="based-title">Binh luận</h2>
                                        ...
                                        <div id="review_form_wrapper">
                                            <div id="review_form">
                                                <div class="comment-respond" id="respond">
                                                    <h3 class="comment-reply-title" id="reply-title">Viết bình luận</h3>
                                                    <form novalidate="" class="comment-form" id="commentform" method="post"
                                                        ...
                                                        <p class="comment-form-email">
                                                            <label for="email">Hình ảnh
                                                            </label>
                                                            <input type="flie" aria-required="true" size="30" value=""
                                                                name="email" id="email">
                                                        </p>
                                                        <p class="form-submit">
                                                            <input type="submit" value="Gửi" class="submit" id="submit"
                                                                name="submit">
