            ...
            <div class="row small-gutters product" id="product_list">
                ...
                <div class="col-6 col-md-4">
                    <div class="grid_item">
                        ...
                        <ul>
                            <li><a href="#" class="tooltip-1" title="Add to favorites"><i class="ti-heart"></i></a></li>
                            <li><a href="#" class="tooltip-1" title="Add to compare"><i class="ti-control-shuffle"></i></a></li>
                            <li><a href="#" class="tooltip-1" title="Add to cart"><i class="ti-shopping-cart"></i></a></li>
                        </ul>
                    </div>
                </div>
                @endforeach
