    ...
    <div class="products">
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                ...
                <img src="{{ url('') }}/home/assets/images/products/5.jpg"
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/16.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/8.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/11.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/10.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/15.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/6.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                ...
                <img src="{{ url('') }}/home/assets/images/products/14.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                ...
                <img src="{{ url('') }}/home/assets/images/products/2.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                ...
                <img src="{{ url('') }}/home/assets/images/products/7.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/4.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/3.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/13.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/9.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/1.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
        ...
        <div class="product">
            ...
            <a href="single-product-fullwidth.html"
                class="woocommerce-LoopProduct-link">
                <img src="{{ url('') }}/home/assets/images/products/12.jpg"
                    width="224" height="197" class="wp-post-image"
                    alt="">
                <span class="price">
                    <ins>
...
<ul role="tablist" class="nav tabs wc-tabs">
    ...
    <li class="nav-item reviews_tab">
        <a class="nav-link" data-toggle="tab" role="tab"
            aria-controls="tab-reviews" href="#tab-reviews">Reviews (1)</a>
    </li>
</ul>
<!-- /.ec-tabs -->
<div class="tab-content">
    ...
    <div class="tab-pane panel wc-tab" id="tab-description" role="tabpanel">
        ...
        <p style="text-align: center;max-width: 1160px;margin: auto auto 60px;">
            ...
            malesuada tincidunt nisl ac commodo. Vivamus eleifend porttitor ex sit
            amet suscipit. Vestibulum at ullamcorper lacus, vel facilisis arcu.
        ...
        <div class="outer-wrap">
            <div class="content-info">
                ...
                <p style="text-align: left;">Nullam dignissim elit ut urna rutrum,
                    a fermentum mi auctor. Mauris efficitur magna orci, et dignissim
                    lacus
            ...
            <div class="image-info">
                <img src="{{ url('') }}/home/assets/images/products/des1.png"
                    alt="">
            </div>
            <!-- .image-info -->
        </div>
        ...
        <div class="outer-wrap">
            ...
            <div class="content-info">
                ...
                <p style="text-align: right;">Nullam dignissim elit ut urna
                    rutrum, a fermentum mi auctor. Mauris efficitur magna orci, et
                    dignissim lacus
                    <br> scelerisque sit amet. Proin malesuada tincidunt nisl ac
                    commodo. Vivamus eleifend porttitor ex sit amet suscipit.
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h2 class="woocommerce-loop-product__title">Snap
                                    White Instant Digital Camera in White</h2>
                                <div class="techmarket-product-rating">
                                    <div title="Rated 0 out of 5" class="star-rating">
                                        <span style="width:0%">
                                            <strong class="rating">0</strong> out
                    ...
                    <a class="woocommerce-LoopProduct-link"
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <!-- .price -->
                                <h2 class="woocommerce-loop-product__title">
                                    Headset 3D Glasses VR for Android</h2>
                                <div class="techmarket-product-rating">
                                    <div title="Rated 0 out of 5" class="star-rating">
                                        <span style="width:0%">
                                            <strong class="rating">0</strong> out
                    ...
                    <a class="woocommerce-LoopProduct-link"
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <!-- .price -->
                                <h2 class="woocommerce-loop-product__title">
                                    Unlocked Android 6″ Inch 4.4.2 Dual Core</h2>
                                <div class="techmarket-product-rating">
                                    <div title="Rated 0 out of 5" class="star-rating">
                                        <span style="width:0%">
                                            <strong class="rating">0</strong> out
