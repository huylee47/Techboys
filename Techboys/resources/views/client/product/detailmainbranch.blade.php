                                                                                ...
                                                                                <p>
                                                                                    ...
                                                                                    @if ($commments->replies->isNotEmpty() && $commments->replies->first()->rep_content)
                                                                                        ...
                                                                                        <button
                                                                                            ...
                                                                                            data-comment-id="{{ $commments->id }}">Hiển
                                                                                            thị phản hồi</button>
                                                                                        <div class="replies-container"
                                                                                            id="replies-container-{{ $commments->id }}"
                                                                                            style="display: none;">
                                                                                    ...
                                                                                    @else
                                                                                        ...
                                                                                        @if (Auth::check() && Auth::user()->role_id == 1)
                                                                                            <button class="reply-button"
                                                                                                data-comment-id="{{ $commments->id }}">Phản
                                                                                                hồi</button>
                                                                                        @endif
                                                                                        <div class="reply-input"
                                                                                            id="reply-input-{{ $commments->id }}"
                                                                                            style="display: none;">
                                                                                            <form method="post"
                                                                                                ...
                                                                                                <input type="hidden"
                                                                                                    ...
                                                                                                    value="{{ $commments->content }}">
                                                                                                <input type="hidden"
                                                                                                    name="comment_rate"
                                                                                                    value="{{ $commments->rate }}">
                                                                                                <input type="hidden"
                                                                                                    name="comment_user_name"
                                                                                                    value="{{ $commments->user->name }}">
                                                                                                <input type="hidden"
                                                                                                    name="comment_created_at"
                                                                                                    value="{{ $commments->created_at }}">
                                                                                                <input type="hidden"
                                                                                                    name="comment_product_id"
                                                                                                    value="{{ $commments->product_id }}">
                                                                                                <input type="hidden"
                                                                                                    name="file_id"
                                                                                                    value="{{ $commments->file_id }}">
                                                                                                <button type="submit"
